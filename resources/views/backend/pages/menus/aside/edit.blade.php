...
@section('headerTitle', 'Edit Aside Menu | '.((isset($site_name)) ? $site_name : ''))
	...
	<section class="content">
		...
		<div>
			<div class="container_fluid">
				...
				<form action="{{ route('admin.aside_menu_edit_process', ['id'=>$result->id]) }}" method="post">
					@csrf
					<div>
						<div class="col-lg-4 col-md-6 form-group pl-0">
							<input type="text" name="name" required Placeholder="Menu Name... *" value="{{ isset($result->name) ? $result->name : '' }}" class="form-control">
						</div>
						<div class="col-lg-4 col-md-6 form-group pl-0">
							<input type="text" name="route_name" Placeholder="Menu Route Name (If Need..)" id="route_name" disabled value="{{ isset($result->route_name) ? $result->route_name : '' }}" class="form-control">
						</div>
						...
						<div class="col-lg-4 col-md-6 form-group pl-0">
							<label class="d_block mt_2 user_select_none">
								<input type="checkbox" name="has_sub_menu" id="has_sub_menu" title="This Menu Has Sub Menu ?" {{ (isset($result->has_sub_menu) && $result->has_sub_menu==1) ? "checked" : '' }} >
								<span class="text_orange text_bold">This Menu Has Sub Menu ?</span>
							</label>
						</div>
						<div class="col-lg-4 col-md-6 form-group pl-0">
							<label class="d_block mt_2 user_select_none">
								<input type="checkbox" name="has_option_menu" title="This Menu Has Options Menu ?" {{ (isset($result->has_option_menu) && $result->has_option_menu==1) ? "checked" : '' }} >
								<span class="text_orange text_bold">This Menu Has Options Menu ?</span>
							</label>
						</div>
						<div class="col_12 px_md_1">
