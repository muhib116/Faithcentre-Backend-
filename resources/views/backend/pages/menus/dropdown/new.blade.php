...
@section('headerTitle', 'Create New Aside Dropdown Menu | '.((isset($site_name)) ? $site_name : ''))
	...
	<section class="content">
		...
		<div>
			<div class="container_fluid">
				...
				<form action="{{ route('admin.store_aside_menu_dropdown') }}" method="post">
					@csrf
					<div>
						<div class="col-lg-4 col-md-6 form-group pl-md-0">
							<select name="aside_menu_id" required class="form-control man_select">
						...
						<div class="col-lg-4 col-md-6 form-group pl-md-0">
							<input type="text" name="name" Placeholder="Deopdown Menu Name... *" required class="form-control">
						</div>
						<div class="col-lg-4 col-md-6 form-group pl-md-0">
							<input type="text" name="route_name" Placeholder="Dropdown Menu's Route Name... *" required class="form-control">
						</div>
