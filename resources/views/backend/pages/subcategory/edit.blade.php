...
@section('content')
	<section class="content">
		...
		<div>
			...
			<form action="{{ route('admin.update_process_subcategory', $result->id).get_system() }}" method="post" enctype="multipart/form-data">
				@csrf
				<div class="col-lg-7 col-12">
					...
					{{-- subcategory logo start --}}
						{{-- <div>
							...
							<div class="image_preview_wrapper">
								<img src="{{ asset('public/backend/images/subcategory/logo/l/'.$result->logo_name) }}" id="logo_preview">
							</div>
						</div> --}}
					...
					{{-- subcategory banner start --}}
						{{-- <div>
							...
							<div class="image_preview_wrapper">
								<img style="max-width: 100%;" src="{{ asset('public/backend/images/subcategory/banner/'.$result->banner_name) }}" id="banner_preview">
							</div>
						</div> --}}
