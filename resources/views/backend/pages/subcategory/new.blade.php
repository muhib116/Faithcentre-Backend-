	...
	<section class="content">
		...
		<div>
			<div class="container_fluid">
				...
				<form action="{{ route('admin.save_new_subcategory').get_system() }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="col-lg-7 col-12">
						...
						<div class="form-group">
							...
							<input type="text" name="name" Placeholder="Subcategory Name..." required class="form-control">
						</div>
