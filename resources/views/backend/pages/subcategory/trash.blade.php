...
@section('headerTitle', 'All Trashed Subcategory | '.((isset($site_name)) ? $site_name : ''))
				...
				<div class="table-responsive">					
					...
					<table class="table table-bordered table_filter">
						<tr>
							...
							{{-- <th style="width: 400px">Subcategory Name (BN)</th> --}}
						...
						@foreach($rows as $key => $value)
							<tr>
								...
								{{-- <td>{{ is_safe($value->subcategory_name_bn) ? $value->subcategory_name_bn : '' }}</td> --}}
								{{-- <td><img style="height: 60px;" src="{{ asset('public/backend/images/subcategory/logo/m/'.$value->logo_name) }}" alt=""></td> --}}
								{{-- <td><img style="height: 60px;" src="{{ asset('public/backend/images/subcategory/banner/'.$value->banner_name) }}" alt=""></td> --}}
								<td>
