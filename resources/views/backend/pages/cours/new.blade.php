...
@section('headerTitle', 'Create New Cours | '.((isset($site_name)) ? $site_name : ''))
	...
	<section class="content">
		...
		<div>
			<div class="container_fluid">
				...
				<form action="{{ route('admin.save_new_cours').get_system() }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="col-lg-7 col-12">
						...
						<div class="form-group">
							...
							<textarea name="meta_description" Placeholder="Meta Description..." required class="form-control" rows="5"></textarea>
						</div>
