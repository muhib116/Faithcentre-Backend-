...
@section('headerTitle', 'Create New Feedback | '.((isset($site_name)) ? $site_name : ''))
	...
	<section class="content">
		...
		<div>
			<div class="container_fluid">
				...
				<form action="{{ route('admin.save_new_customer_feedback').get_system() }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="col-lg-7 col-12">
						...
						<div class="form-group">
							...
							<textarea name="details" Placeholder="Write Review... *" rows="4" required class="form-control"></textarea>
						</div>
						<br>
