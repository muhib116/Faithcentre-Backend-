...
@section('headerTitle', 'All Trashed Feedback | '.((isset($site_name)) ? $site_name : ''))
					...
					<table class="table table-bordered table_filter">
						...
						@foreach($rows as $key => $value)
							<tr>
								...
								<td>{{ $value->details }}</td>
								<td>
									<img style="height: 60px;" src="{{ asset('public/backend/img/customer_feedback/m/'.$value->path) }}" alt="">
								</td>
								<td>
