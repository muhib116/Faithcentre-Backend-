...
@section('headerTitle', 'All User | '.((isset($site_name)) ? $site_name : ''))
					...
					<table class="table table-bordered table_filter">
						...
						@foreach($rows as $key => $value)
							<tr>
								...
								<td><span class="badge badge-warning">{{ !empty($value->trx_id) ? $value->trx_id : 'n/a' }}</span></td>
								{{-- <td>
									<img style="height: 60px;" src="{{ asset('public/backend/img/our_security/l/'.$value->path) }}" alt="">
								</td> --}}
								<td>
