...
@section('headerTitle', 'Create New Slider | '.((isset($site_name)) ? $site_name : ''))
	...
	<section class="content">
		...
		<div>
			<div class="container_fluid">
				...
				<form action="{{ route('admin.save_new_slider').get_system() }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="col-lg-7 col-12">
						<div class="form-group">
								<label class="label-control">Slider Caption</label>
								<input type="text" name="caption" Placeholder="Slider Caption... *" required class="form-control">
							</div>
							
							<div class="form-group">
								<label class="label-control">Link</label>
								<input type="url" name="link" Placeholder="Link... *" required class="form-control">
							</div>
							
							<div class="form-group">
								<label class="label-control">Anchor text</label>
								<input type="text" name="anchor_text" Placeholder="Anchor text... *" required class="form-control">
							</div>

							<div class="form-group">
								<label class="label-control">Slider Description</label>
								<textarea name="description" Placeholder="Slider Description..." class="form-control"></textarea>
							</div>	
						<br>
