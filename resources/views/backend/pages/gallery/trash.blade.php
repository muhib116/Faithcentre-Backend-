...
@section('headerTitle', 'All Trashed Image/Photo | '.((isset($site_name)) ? $site_name : ''))
				...
				<div class="table-responsive">					
					...
					<table class="table table-bordered table_filter">
						<tr>
							<th width="30px">SL</th>
							<th >Caption</th>
							<th style="width: 60px;">Image/Photo</th>
						...
						@foreach($rows as $key => $value)
							<tr>
								<td>{{ $key+1 }}</td>
								<td>{{ $value->caption }}</td>
								<td><img style="height: 60px;" src="{{ asset('public/backend/images/gallery/l/'.$value->image_name) }}" alt=""></td>
