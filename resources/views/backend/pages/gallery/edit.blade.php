...
@section('headerTitle', 'Update Image/Photo | '.((isset($site_name)) ? $site_name : ''))
		...
		@if($result)
			<div>
				<div class="container_fluid">
					...
					<form action="{{ route('admin.update_process_gallery', $result->id).get_system() }}" method="post" enctype="multipart/form-data">
						@csrf
						<div class="col-lg-7 col-12">

							<div class="form-group">
								<label class="label-control">Caption *</label>
								<input type="text" name="caption" value="{{ $result->caption }}" id="caption" Placeholder="Caption..." required class="form-control">
							</div>

							<div class="form-group">
								<label class="label-control">Slug *</label>
								<input type="text" name="slug" value="{{ $result->slug }}" id="caption_slug" Placeholder="Slug..." required class="form-control">
							</div>

							<div class="form-group">
								<label class="label-control">Detail</label>
								<textarea name="detail" Placeholder="Detail..." class="form-control">{{ $result->detail }}</textarea>
							</div>
								...
								<label class="image_upload_zone" for="">
									...
									<div class="text">
										...
										<span>
											...
											<br>
											Gallery Image/Photo Size Limit: 400kb
										</span>
									</div>
								</label>
								
								<div class="image_preview_wrapper">
									<img src="{{ asset("public/backend/images/gallery/l/".$result->image_name) }}" id="image_preview">
								</div>
							</div>
							{{-- Page Gallery end --}}
