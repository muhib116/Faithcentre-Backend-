...
@section('headerTitle', 'Create New Category | '.((isset($site_name)) ? $site_name : ''))
	...
	<section class="content">
		...
		<div>
			<div class="container_fluid">
				...
				<form action="{{ route('admin.save_new_category').get_system() }}" method="post" enctype="multipart/form-data">
					@csrf
