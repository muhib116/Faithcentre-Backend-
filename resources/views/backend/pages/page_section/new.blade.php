...
@section('headerTitle', 'Create New Section | '.((isset($site_name)) ? $site_name : ''))
	...
	<section class="content">
		...
		<div>
			<div class="container_fluid">
				...
				<form action="{{ route('admin.save_new_page_section').get_system() }}" method="post" enctype="multipart/form-data">
					@csrf
					<div class="col-lg-7 col-12">
						<div class="form-group">
							...
							<select name="section_name" required class="form-control">
								...
								<option value="why-choose-us">Ahy Choose Us</option>
						...
						<div class="form-group">
							...
							<input type="text" name="slug" id="title_slug" Placeholder="Slug..." required class="form-control">
						</div>

						<div class="form-group">
							<label class="label-control">Short Detail *</label>
							<textarea name="short_detail" Placeholder="Short Detail..." required class="form-control"></textarea>
						</div>
