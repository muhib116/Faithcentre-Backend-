...
@section('headerTitle', 'Update Report | '.((isset($site_name)) ? $site_name : ''))
		...
		@if($result)
			...
			<div>
				<div class="container_fluid">
					...
					<form action="{{ route('admin.update_process_report', $result->id).get_system() }}" method="post" enctype="multipart/form-data">
						@csrf
						<div class="col-lg-10">
