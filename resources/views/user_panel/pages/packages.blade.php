...
@section('content')
	@if($user_active_package)
		<a href="{{ route('user.package_upgrade') }}">Upgrade Your Package</a>
	@else
	    {!! msg($name='msg') !!}
	    @if ($errors->any())
		...
		<div class="card_container">
	        ...
	        <div class="single_card">
	            ...
	            <div class="footer">
	                <a href="{{ route('user.process_package', 'bronze') }}">
	        ...
	        <div class="single_card active">
	            ...
	            <div class="footer">
	                <a href="{{ route('user.process_package', 'silver') }}">
	                    <span class="text">Buy This package</span>
	                    <span class="icon">
	                        <svg viewBox="0 0 451.846 451.847">
	                            <path
	        ...
	        <div class="single_card">
	            ...
	            <div class="footer">
	                <a href="{{ route('user.process_package', 'gold') }}">
	                    <span class="text">Buy This package</span>
	                    <span class="icon">
	                        <svg viewBox="0 0 451.846 451.847">
	                            <path
