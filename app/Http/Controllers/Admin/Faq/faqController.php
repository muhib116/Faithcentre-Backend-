<?php
    ...
    class faqController extends Controller{
        ...
        public function create(){
            return view('backend.pages.faq.new')->with($this->data);
        }
        ...
        public function edit($id){
            ...
            $this->data['id'] = $id;
            $this->data['result'] = DB::table('faqs')->where(['id'=>$id])->first();
            
            return view('backend.pages.faq.edit')->with($this->data);
        }
        ...
        public function edit_process(Request $request, $id){
            ...
            if(DB::table('faqs')->where(['id'=>$id])->update($data))
            {
        ...
        public function trash_list(){
            ...
            return view('backend.pages.faq.trash')->with($this->data);
        }
        ...
        public function delete(Request $request,$id){
            ...
            if($delete_status){
                // unlink all img and banner of this subpages start------------
                if(file_exists('public/backend/images/pages/l/'.$old_data->image_name) and !empty($old_data->image_name))
                {
                    unlink('public/backend/images/pages/l/'.$old_data->image_name);
                }
                // unlink all img and banner of this subpages end--------------
