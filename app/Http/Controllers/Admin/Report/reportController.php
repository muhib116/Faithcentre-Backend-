<?php
    ...
    class reportController extends Controller{
        ...
        public function index()
        {
            ...
            return view('backend.pages.report.all')->with($this->data);
        }
        ...
        {
            return view('backend.pages.report.new')->with($this->data);
        }
        ...
        public function edit($id)
        {
            ...
            return view('backend.pages.report.edit')->with($this->data);
        }
        ...
        public function trash_list()
        {
            ...
            return view('backend.pages.report.trash')->with($this->data);
        }
        ...
        public function overview()
        {
           ...
           if(count($report_data))
           {
            ...
            return view('backend.pages.report.overview')->with($this->data);
        }
        ...
        public function single_overview($type, $id)
        {
           ...
           if(count($report_data))
           {
            ...
            return view('backend.pages.report.single_person_chart')->with($this->data);
        }
